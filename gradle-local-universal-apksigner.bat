...
zipalign -v -p 4 E:\Lazarus-Projecten\Hallo\HalloLazAnd\build\outputs\apk\release\HalloLazAnd-universal-release-unsigned.apk E:\Lazarus-Projecten\Hallo\HalloLazAnd\build\outputs\apk\release\HalloLazAnd-universal-release-unsigned-aligned.apk
apksigner sign --ks E:\Lazarus-Projecten\Hallo\HalloLazAnd\hallolazand-release.keystore --ks-pass pass:123456 --key-pass pass:123456 --out E:\Lazarus-Projecten\Hallo\HalloLazAnd\build\outputs\apk\release\HalloLazAnd-release.apk E:\Lazarus-Projecten\Hallo\HalloLazAnd\build\outputs\apk\release\HalloLazAnd-universal-release-unsigned-aligned.apk
