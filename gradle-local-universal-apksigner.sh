...
zipalign -v -p 4 /Lazarus-Projecten/Hallo/HalloLazAnd/build/outputs/apk/release/HalloLazAnd-universal-release-unsigned.apk /Lazarus-Projecten/Hallo/HalloLazAnd/build/outputs/apk/release/HalloLazAnd-universal-release-unsigned-aligned.apk
apksigner sign --ks /Lazarus-Projecten/Hallo/HalloLazAnd/hallolazand-release.keystore --ks-pass pass:123456 --key-pass pass:123456 --out /Lazarus-Projecten/Hallo/HalloLazAnd/build/outputs/apk/release/HalloLazAnd-release.apk /Lazarus-Projecten/Hallo/HalloLazAnd/build/outputs/apk/release/HalloLazAnd-universal-release-unsigned-aligned.apk
